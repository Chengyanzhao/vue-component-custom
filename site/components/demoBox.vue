    ...
    <section class="code-box-demo">
      <template v-if="iframeDemo[iframeDemoKey]">
        <div class="browser-mockup with-url">
          <iframe :src="iframeDemo[iframeDemoKey]"
                  height="360" />
        </div>
      </template>
      <template v-else>
...
<script>
import animate from 'com/_util/openAnimation'
import BaseMixin from 'com/_util/BaseMixin'
