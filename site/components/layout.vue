...
import zhCN from "com/locale-provider/zh_CN"
import enUS from "com/locale-provider/default"
import sortBy from "lodash/sortBy"
import { isZhCN } from "../util"
import { Provider, create } from "com/_util/store"
import NProgress from "nprogress"
import { Drawer as MobileMenu } from "ant-design-vue"
...
const docsList = [
  ...
  {
    key: "use-with-vue-cli",
    enTitle: "Use in vue-cli",
    title: "在 vue-cli 中使用"
  },
              ...
              {isMobile ? (
                <MobileMenu ref="sidebar" wrapperClassName="drawer-wrapper">
                  ...
                  >
                    ...
                    <a-sub-menu title="Directives(1)" key="Directives">
                      {DirectGroup}
                    </a-sub-menu>
                  </a-menu>
                </MobileMenu>
                    ...
                    <a-affix>
                      <section class="main-menu-inner">
                        ...
                        >
                          ...
                          <a-sub-menu
                            title={`Directives(${DirectGroup.length})`}
                            key="Directives"
                          >
                            {DirectGroup}
                          </a-sub-menu>
